...
func HasMembershipsWith(preds ...predicate.GroupMember) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// HasSentGroupMessages applies the HasEdge predicate on the "sent_group_messages" edge.
func HasSentGroupMessages() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasSentGroupMessagesWith applies the HasEdge predicate on the "sent_group_messages" edge with a given conditions (other predicates).
func HasSentGroupMessagesWith(preds ...predicate.GroupMessage) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newSentGroupMessagesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
