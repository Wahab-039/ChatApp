...
func HasCreator() predicate.Group {
...
func HasCreatorWith(preds ...predicate.User) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := newCreatorStep()
...
func HasMembershipsWith(preds ...predicate.GroupMember) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func HasMessagesWith(preds ...predicate.GroupMessage) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
