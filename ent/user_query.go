...
type UserQuery struct {
	...
	withMemberships       *GroupMemberQuery
	withSentGroupMessages *GroupMessageQuery
...
func (_q *UserQuery) QuerySentMessages() *DirectMessageQuery {
...
func (_q *UserQuery) QueryReceivedMessages() *DirectMessageQuery {
	query := (&DirectMessageClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *UserQuery) QueryCreatedGroups() *GroupQuery {
...
func (_q *UserQuery) QueryMemberships() *GroupMemberQuery {
...
// QuerySentGroupMessages chains the current query on the "sent_group_messages" edge.
func (_q *UserQuery) QuerySentGroupMessages() *GroupMessageQuery {
	query := (&GroupMessageClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withReceivedMessages:  _q.withReceivedMessages.Clone(),
		withCreatedGroups:     _q.withCreatedGroups.Clone(),
		withMemberships:       _q.withMemberships.Clone(),
		withSentGroupMessages: _q.withSentGroupMessages.Clone(),
...
func (_q *UserQuery) WithSentMessages(opts ...func(*DirectMessageQuery)) *UserQuery {
	query := (&DirectMessageClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithReceivedMessages(opts ...func(*DirectMessageQuery)) *UserQuery {
	query := (&DirectMessageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withReceivedMessages = query
	return _q
}
...
func (_q *UserQuery) WithCreatedGroups(opts ...func(*GroupQuery)) *UserQuery {
	query := (&GroupClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithMemberships(opts ...func(*GroupMemberQuery)) *UserQuery {
	query := (&GroupMemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithSentGroupMessages tells the query-builder to eager-load the nodes that are connected to
// the "sent_group_messages" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithSentGroupMessages(opts ...func(*GroupMessageQuery)) *UserQuery {
	query := (&GroupMessageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withSentGroupMessages = query
	return _q
}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	var (
		...
		loadedTypes = [5]bool{
			...
			_q.withReceivedMessages != nil,
			_q.withCreatedGroups != nil,
			_q.withMemberships != nil,
			_q.withSentGroupMessages != nil,
		}
	)
	...
	if query := _q.withReceivedMessages; query != nil {
		if err := _q.loadReceivedMessages(ctx, query, nodes,
	...
	if query := _q.withMemberships; query != nil {
		if err := _q.loadMemberships(ctx, query, nodes,
			func(n *User) { n.Edges.Memberships = []*GroupMember{} },
			func(n *User, e *GroupMember) { n.Edges.Memberships = append(n.Edges.Memberships, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSentGroupMessages; query != nil {
		if err := _q.loadSentGroupMessages(ctx, query, nodes,
			func(n *User) { n.Edges.SentGroupMessages = []*GroupMessage{} },
			func(n *User, e *GroupMessage) { n.Edges.SentGroupMessages = append(n.Edges.SentGroupMessages, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadSentMessages(ctx context.Context, query *DirectMessageQuery, nodes []*User, init func(*User), assign func(*User, *DirectMessage)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(directmessage.FieldSenderID)
	}
...
func (_q *UserQuery) loadReceivedMessages(ctx context.Context, query *DirectMessageQuery, nodes []*User, init func(*User), assign func(*User, *DirectMessage)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(directmessage.FieldRecipientID)
	}
	query.Where(predicate.DirectMessage(func(s *sql.Selector) {
...
func (_q *UserQuery) loadCreatedGroups(ctx context.Context, query *GroupQuery, nodes []*User, init func(*User), assign func(*User, *Group)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(group.FieldCreatedBy)
	}
...
func (_q *UserQuery) loadMemberships(ctx context.Context, query *GroupMemberQuery, nodes []*User, init func(*User), assign func(*User, *GroupMember)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *UserQuery) loadSentGroupMessages(ctx context.Context, query *GroupMessageQuery, nodes []*User, init func(*User), assign func(*User, *GroupMessage)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(groupmessage.FieldSenderID)
	}
	query.Where(predicate.GroupMessage(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.SentGroupMessagesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
